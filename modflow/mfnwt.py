...
class ModflowNwt(Package):
    ...
    def load(f, model, ext_unit_dict=None):
        ...
        specdict = (('dbdtheta', float), ('dbdkappa', float),
                    ('dbdgamma', float), ('momfact', float),
                    ('backflag', int), ('maxbackiter', int),
                    ('backtol', float), ('backreduce', float))
        ...
        if kwargs["options"].lower().strip() == "specified":
            ...
            if kwargs['linmeth'] == 1:
                lindict = (('maxitinner', int), ('ilumethod', int),
                           ('levfill', int), ('stoptol', float),
                           ('msdr', int))
            elif kwargs['linmeth'] == 2:
                lindict = (('iacl', int), ('norder', int), ('level', int),
                           ('north', int), ('iredsys', int),
                           ('rrctols', float),
                           ('idroptol', int), ('epsrn', float),
                           ('hclosexmd', float),
                           ('mxiterxmd', int))
